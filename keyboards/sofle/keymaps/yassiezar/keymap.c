...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LCTR | LAlt | ULYR | LGUI | /SPACE  /       \ENTER \  | LLYR | PSCR |  HME |  END |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
 ...
 */
[_LOWER] = LAYOUT(
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                         KC_PIPE, UM(GBP), KC_LABK, KC_RABK, KC_NO,   KC_NO,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Esc  | Ins  | Pscr | Menu |      |      |                    |      | PWrd |      | NWrd | DLine| F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift|      | Caps |-------.    ,-------| LEFT | UP   | DOWN | RIGHT|  Del | Bspc |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  KC_NO, KC_NO,                        KC_PGUP, KC_PRVWD,   KC_NO, KC_NXTWD,KC_DLINE, KC_F12,
  _______, KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_CAPS,                       KC_LEFT,  KC_UP, KC_DOWN, KC_RGHT,  KC_DEL, KC_BSPC,
