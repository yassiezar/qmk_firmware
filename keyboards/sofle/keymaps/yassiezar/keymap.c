...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LCTR | LAlt | LLYR | LGUI | /SPACE  /       \ENTER \  |   ULYR  | PSCR |  HME |  END |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,     KC_MUTE,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_NUBS,
                 KC_LCTL,KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC,      KC_ENT, MO(_RAISE), KC_PSCR, KC_HOME, KC_END
),
 ...
 */
[_LOWER] = LAYOUT(
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                         KC_PIPE, UM(GBP), KC_LABK, KC_RABK, KC_UNDERSCORE,   KC_NO,
  _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,                         KC_7,    KC_8,    KC_9,    KC_PMNS, KC_PSLS, KC_NO,
  _______, KC_PEQL, KC_PMNS, KC_PPLS, KC_LCBR, KC_RCBR,                         KC_4,    KC_5,    KC_6,    KC_PPLS, KC_PAST, KC_PIPE,
  _______, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, _______,       _______, KC_1,    KC_2,    KC_3,    KC_0,    KC_BSLS, KC_NO,
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Esc  | Ins  | Pscr | Menu |      |      |                    |      | PgDn | PgUp | NWrd | DLine| F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift|      | Caps |-------.    ,-------| LEFT | DOWN |  UP  | RIGHT|  Del | Bspc |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * |Shift | Redo | Undo |  Cut | Copy | Paste|-------|    |-------|      | LStr |      | LEnd |      | Shift|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTR | LAlt | LLYR | LGUI | /SPACE  /       \ENTER \  |   ULYR  | PSCR |  HME |  END |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
...
[_RAISE] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  KC_NO, KC_NO,                        KC_NO, KC_PGDN, KC_PGUP, KC_NXTWD,KC_DLINE, KC_F12,
  _______, KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_CAPS,                       KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,  KC_DEL, KC_BSPC,
  _______,KC_UNDO, KC_AGAIN, KC_CUT, KC_COPY, KC_PASTE,  _______,       _______,  XXXXXXX, KC_LSTRT, XXXXXXX, KC_LEND,   _______, _______,
                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
